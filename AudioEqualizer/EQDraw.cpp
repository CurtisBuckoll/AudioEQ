...
static const double kFREQ_SPECTRUM_HEIGHT_DAMPENING = 40.0;
...
{
    // TODO: Clean this up. This contains the (modified) code to draw line using non-antialiased technique.
